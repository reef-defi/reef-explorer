...
const contractId = '0xFd63B5eeeF46c411Cd4bc12511B10B129aD1dff3'; // RURU
// const contractId = '0x33bEaD687546ba417c170C0523155b2dCf45106B'; // ETHBOX
...
const main = async () => {
  ...
  if (isErc20 === true) {
    ...
    console.log(`Contract ${contractId} is NOT an ERC20 token`);
  }
