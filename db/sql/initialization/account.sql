...
INSERT INTO account 
  (block_id, evm_address, address, active, available_balance, free_balance, locked_balance, reserved_balance, vested_balance, voting_balance, nonce)
VALUES
  (-1, '0x', '0x', true, 0, 0, 0, 0, 0, 0, 0),
  (-1, 'deleted', 'deleted', true, 0, 0, 0, 0, 0, 0, 0);